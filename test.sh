...
f() {
  clang++ -std=c++2b -Weverything -Wno-c++98-compat-pedantic -Wno-c11-extensions -pedantic-errors -I./include -I./third-party/iutest/include -O2 -pipe -o /tmp/a.out "$i" || return
  /tmp/a.out || return
